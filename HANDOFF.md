# Cozy Tavern — handoff for the next session (state at m478-001)

## READ THIS FIRST — HIS STORYTELLER'S PERSONA IS THE THING THAT BREAKS
1q. A #STORY CONCEPT IS THE BRIEF (M478): chat.js writes the raw concept into an EMPTY brief on send, agents/concept.js
   polishes it in the background (acceptablePolish guards names and size); the founder re-reads the brief at run time.
