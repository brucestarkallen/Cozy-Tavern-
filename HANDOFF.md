# Cozy Tavern — handoff for the next session (state at m428-001)
...
- NOTHING IS REDRAWN UNDER HIS FINGERS (M428): the drawer's background redraw waits while a text field of it has the
  focus; Settings never draws a box he is typing in over his draft. Any new background redraw must do the same.
