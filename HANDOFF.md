# Cozy Tavern — handoff for the next session (state at m404-001)
...
- `node tests/harness/run.mjs` — 799 checks on the engines, assembler, workers, laws (run it detached: it takes longer than one 300 s tool call).
