...
function law({ mc, clockWords, hourWords = '', jumpWords = '' }) {
  ...
  return [
    ...
    'WHAT THE WORLD CAN SEE OR HEAR REACHES IT NOW (M500). When the newest page has something beyond the room — a sonic',
    'boom over the city, an explosion, a pillar of spiritual pressure, sirens, a fire, a scream across the square — every',
    'offstage person within its range by world logic (sight, sound, a runner, a message) reacts on THIS page in their own',
    'way and by their own stake: looks up, stops mid-task, sends someone, files it, changes plans, ignores it on purpose —',
    'each with a real offscreen.set, however few minutes of story have passed; a faction or thread it touches moves too.',
    'Nobody out of range reacts, and nobody learns more than the sight or sound itself gave them.',
