 ...
 * pages. */
export const WORKER_NAMES = ['founder', 'eye', 'extractor', 'world', 'scribe', 'keeper', 'referee', 'continuity', 'auditor', 'ripple', 'housekeeper', 'director', 'editor', 'sensors', 'canon']; /* M356; M386: canon verification's runs are noted like any worker's */
