...
test('M15 motion & depth: the surface laws hold', () => {
  ...
  assert(/\.msg\.fresh\s*\{\s*animation:\s*msg-rise 0\.25s ease-out/.test(chat) && !/content-visibility/.test(chat), 'only a fresh page rises 12px .25s ease-out; no content-visibility (it broke scrolling on Android — M139)');
